...
//	23/10/26 V1.1		Support MSX0 official Release version
//
////////////////////////////////////////////////////////////////////////
// 下記ライブラリを使用しています。
...
unsigned char firstBoot = 0;			// 書き込みモードのBUSY OUTフラグ
...
unsigned char byteDAT[32];				// I2C 受信buffer


// I2C 0x08の割り込み(read)処理
void requestEvent()
{
